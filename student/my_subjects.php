  ...
  <div class="content">
    ...
    <div class="card">
      <div class="card-head">
        ...
        <a href="/student/enroll.php" class="btn btn-primary btn-sm">+ Add Subject</a>
      </div>
      <table class="tbl">
        ...
        <tbody>
          ...
          <tr class="empty-row"><td colspan="8">No subjects enlisted. <a href="/student/enroll.php">Enroll now</a></td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
